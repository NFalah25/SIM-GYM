...
function TableNewLangganan({ columns, children }) {
    return (
...
TableNewLangganan.Header = Header;
TableNewLangganan.Row = Row;
TableNewLangganan.Body = Body;
TableNewLangganan.Footer = Footer;

export default TableNewLangganan;
