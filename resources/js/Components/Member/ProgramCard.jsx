...
function ProgramCard({ presensi, program }) {
    ...
    return (
        <div
            className={`box-border flex w-full items-center gap-2 rounded-lg p-4 outline-dashed outline-2 ${presensi ? "outline-green-500" : "outline-lime-500"} md:w-[calc(50%-1.25rem)] lg:w-[calc(33.333%-1.25rem)] ${presensi ? null : " opacity-50"}`}
        >
