...
function TransaksiIndex({ tbody, thead, pagination }) {
    ...
    return (
        <Dashboard>
            ...
            <Row>
                <form onSubmit={submit} className="p-4 border-b border-gray-600 bg-slate-700 text-slate-300 rounded-md">
                    ...
                    <div className="md:flex">
                        <div className="md:w-2/5 md:pe-4">
                            ...
                            <Input type="date" value={data.mulai_tanggal} name={'mulai_tanggal'} id={'mulai_tanggal'} onChange={(e)=>setData('mulai_tanggal', e.target.value)} />
                        </div>
                        ...
                        <div className="md:w-1/5 flex h-full items-center md:ps-4 justify-evenly">
                            ...
                            <div className="py-6">
                                <button className="bg-slate-400 text-slate-100 transition-all duration-300 text-lg md:text-xs lg:text-base font-semibold rounded-lg border border-slate-400 px-4 py-2 hover:bg-lime-600" type="reset" onClick={onClickReset}>Reset</button>
                            </div>
                        </div>
                    </div>
                </form>
