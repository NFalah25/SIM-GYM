...
function Welcome({program}) {
  return (
    ...
    <div className="sm:w-1/2 mb-10 sm:mb-0 sm:pl-20">
        <h2 className="text-6xl font-bold mb-4">Helps for your ideal body fitness</h2>
    ...
    <section className="py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 gap-10 px-10 pl-20 pr-20">
            {/* <div className="border-2 border-green-500 border-dashed bg-slate-950 p-5">
                ...
                <p className="mt-2 text-green-400">Every Mon and Wed at 4 pm</p>
            </div>
            <div className="border-2 border-green-500 border-dashed bg-slate-950 p-5">
                <img src="assets/img/Media Container-1.png" alt="Free Weights" className="hidden sm:block mb-4"/>
                <h3 className="text-xl font-bold mb-2">Free Weights</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut venenatis, nunc a pretium viverra.</p>
                <p className="mt-2 text-green-400">Everyday at 6 am - 10 pm</p>
            </div>
            <div className="border-2 border-green-500 border-dashed bg-slate-950 p-5">
                <img src="assets/img/Media Container-2.png" alt="Pound Fit" className="hidden sm:block mb-4"/>
                <h3 className="text-xl font-bold mb-2">Pound Fit</h3>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut venenatis, nunc a pretium viverra.</p>
                <p className="mt-2 text-green-400">Every Tue and Thu at 4 pm</p>
            </div>
            <div className="border-2 border-green-500 border-dashed bg-slate-950 p-5">
    ...
    <section className="pl-20">
        ...
        <div className="flex flex-col bg-black bg-opacity-20">
            <img src="assets/img/Frame 75.png" className="hidden sm:block mb-4"/>
        </div>
        <div className="flex flex-col ml-5 w-[43%] max-md:ml-0 max-md:w-full pr-20">
            <div className="flex flex-col items-start self-stretch p-2.5 my-auto text-base font-medium text-neutral-200 max-md:mt-10 max-md:max-w-full">
            <h1 className="self-stretch text-5xl font-bold text-white max-md:max-w-full max-md:text-4xl">
            ...
            <div className="flex gap-4 self-stretch mt-6 text-lg font-semibold leading-6 text-center text-white max-md:flex-wrap">
                <a href={route('register')} className="btn-green px-3 py-2 rounded">
                    Join now
                </a>
    ...
    <section className="flex justify-center items-center px-5 py-20 w-full bg-slate-950 max-md:max-w-full">
        <div className="w-full max-w-[1200px] max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                <div className="flex flex-col w-2/5 max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col grow items-start text-white max-md:mt-10 pl-20">
                        <h1 className="self-stretch text-4xl font-bold">
                            What Our Member Say About Us?
                        </h1>
                        <img src="assets/img/Text.png" className="mt-36 max-w-full rounded-full border-2 border-white border-solid aspect-[2.27] w-[127px] max-md:mt-10" />
                        <h3 className="mt-6 text-lg font-medium">10K+ Satisfied Customer</h3>
                    </div>
                </div>
                <div className="flex flex-col ml-20 w-3/5 max-md:ml-20 max-md:w-full pr-20">
                    <div className="flex flex-col grow self-stretch pt-5 pb-6 w-full rounded-xl border-2 border-green-500 border-dashed bg-slate-950 max-md:mt-10 max-md:max-w-full">
                        <div className="flex gap-1 self-end mr-16 max-md:mr-2.5">
                        ...
                        <div className="flex flex-col items-start pl-12 mt-10 max-md:pl-5 max-md:mt-10 max-md:max-w-full">
                            <div className="flex gap-5 justify-between items-start max-md:flex-wrap">
                                <p className="self-start text-lg text-white text-opacity-80 max-md:max-w-full">
                                ...
                                <div className="flex justify-center items-center self-end p-20.5 mt-20">
                            ...
                            <div className="flex gap-2 items-center self-center mt-7 ml-9">
                                <div className="shrink-0 self-stretch w-4 h-4 bg-green-500 rounded-full"></div>
                                <div className="shrink-0 self-stretch my-auto w-3 h-3 bg-gray-600 rounded-full"></div>
                                <div className="shrink-0 self-stretch my-auto w-3 h-3 bg-gray-600 rounded-full"></div>
                            </div>
                        </div>
                    </div>
    ...
    <section className="flex gap-5 justify-between items-start py-20 w-full max-md:flex-wrap max-md:max-w-full">
    <div className="flex flex-col text-sm font-medium leading-5 text-white pl-20">
    <img src="assets/img/zeus 2.png" alt="Zeus Physique" className="hidden sm:block w-48 h-auto"/>
        <h3 className="sm:w-1/2 mt-4">
        Highlight benefits of each exercise, both physical and mental
        </h3>
    </div>
    <div className="flex gap-5 justify-between pr-20">
        <div className="flex flex-col text-base text-white pr-10">
        ...
        <div className="flex gap-1 mt-2.5 max-md:pr-5">
        <a href="#">
            <img src="assets/img/instagram.png" className="shrink-10 w-10 aspect-square"/>
        </a>
        <a href="#">
            <img src="assets/img/Twitter.png" className="shrink-10 w-10 aspect-square"/>
        </a>
        <a href="#">
            <img src="assets/img/Facebook.png" className="shrink-10 w-10 aspect-square"/>
        </a>
        </div>
        </div>
    </div>
    ...
    <footer className="py-5 text-start border-t-2 border-t-lime-500">
        <div className="flex flex-col sm:flex-row justify-between">
            <p className="flex items-center mb-2 sm:mb-0 sm:pl-20">
        ...
        <div className="flex items-center pr-20 text-gray-600 ">
            ...
            <a href="#" className="mb-2 sm:mb-0 sm:pl-5">Privacy Policy</a>
        </div>
        </div>
    </footer>
    </div>
